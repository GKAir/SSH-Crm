													...
													<TBODY>
														...
														<TR>
															<TD style="HEIGHT: 18px" colspan="3">
																<s:actionerror style="text-decoration: none;color: red;font-size: 14px;" />
															</TD>
														</TR>
														<TR>
															<TD></TD>
															<TD>
																<INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("btn", "", true, "", "", false, false))' type=image src="${pageContext.request.contextPath}/images/login_button.gif">
															</TD>
														</TR>
													</TBODY>
												</TABLE>
