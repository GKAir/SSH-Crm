					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>邮政编码 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="custZip" value="${customer.custZip}">
								</td>
							</TR>
							<TR>
								<td>联系电话 ：</td>
								...
								<td>客户传真 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="custFax" value="${customer.custFax}">
								</td>
							</TR>
							<TR>
								<td>客户网址 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="custWebsite" value="${customer.custWebsite}">
								</td>
								<td>企业法人 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="custCorporation" value="${customer.custCorporation}">
								</td>
							</TR>
							<TR>
								<td>客户网址 ：</td>
								<td colspan="2">
									<textarea rows="5" cols="30" class=textbox id=sChannel2 style="WIDTH: 180px"  name="custMemo">
										${customer.custMemo}
									</textarea>
								</td>
							</TR>
